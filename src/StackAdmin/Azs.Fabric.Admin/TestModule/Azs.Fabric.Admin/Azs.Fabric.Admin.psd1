...
GUID = '87609d22-412a-41be-94fd-93c83ddca5c6'
...
FunctionsToExport = 'Restart-AzsInfrastructureRoleInstance', 'Get-AzsStorageSystem', 
               'Repair-AzsScaleUnitNode', 'Stop-AzsScaleUnitNode', 
               ...
               'New-AzsInfrastructureLocation', 'Get-AzsMacAddressPool', 
               'Get-AzsEdgeGatewayPool', 'Submit-AzsScaleUnitNodeShutdown', 
               'Get-AzsEdgeGateway', 'Get-AzsInfrastructureVolume', 
               'Enable-AzsScaleUnitNode', 'Get-AzsInfrastructureRole', 
               'Get-AzsIpPool', 'Get-AzsLogicalSubnet', 'Add-AzsScaleUnitNode', 
               'Get-AzsInfrastructureLocation', 'Get-AzsFabricOperations', 
               'Set-AzsIpPool', 'Get-AzsStoragePool', 'Start-AzsScaleUnitNode', 
               'Get-AzsInfrastructureRoleInstance', 
               'Stop-AzsInfrastructureRoleInstance', 
               'New-BareMetalNodeDescriptionObject', 'New-FabricLocationObject', 
               'New-ScaleOutScaleUnitParametersListObject', 'New-IpPoolObject', 
